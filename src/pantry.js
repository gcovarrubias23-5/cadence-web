...
export const PANTRY = [
  ...
  item('Cucumber', 'Produce', 'free', 0.7, 3.6, 0.1, '1/2 cup cucumber', 80),
  item('Celery', 'Produce', 'free', 0.7, 3, 0.2, '2 celery sticks', 80),
  item('Zucchini', 'Produce', 'free', 1.2, 3.1, 0.3, '1 cup zucchini', 100),
  item('Broccoli', 'Produce', 'free', 2.8, 7, 0.4, '2 cups broccoli', 150),
  item('Cauliflower', 'Produce', 'free', 1.9, 5, 0.3, '1 cup cauliflower', 100),
  item('Cabbage slaw', 'Produce', 'free', 1.3, 6, 0.1, '1 cup cabbage', 70),
  item('Green beans', 'Produce', 'free', 1.8, 7, 0.2, '2 handfuls green beans', 150),
  ...
  item('Onion', 'Produce', 'free', 1.1, 9, 0.1, '1/2 small onion', 60),
]
